...
public class TagProviderTest extends AndroidTestCase {
    ...
    public void testQueryMultipleTags() {
        ...
        assertEquals("TestTag1", productCursor.getString(productCursor.getColumnIndex(Tag.COLUMN_NAME)));
        assertEquals(uuid, productCursor.getString(productCursor.getColumnIndex(Tag.COLUMN_ID)));
        ...
        productCursor = mTagProvider.query(multipleTagsUri, null, null, null, Tag.COLUMN_NAME + " ASC");
        assertNotNull(productCursor);
        ...
        assertEquals("TestTag2", productCursor.getString(productCursor.getColumnIndex(Tag.COLUMN_NAME)));
        assertEquals(uuid2, productCursor.getString(productCursor.getColumnIndex(Tag.COLUMN_ID)));
        resetDb();
    }
    ...
    public void testInsertSingleTag() {
        ...
        Cursor cursor = mTagProvider.query(uri, Tag.ALL_COLUMNS, null, null, null);
        assertNotNull(cursor);
        assertEquals(1, cursor.getCount());
        cursor.moveToFirst();
        assertEquals(uuid, cursor.getString(cursor.getColumnIndex(Tag.COLUMN_ID)));
        assertEquals("TestTag", cursor.getString(cursor.getColumnIndex(Tag.COLUMN_NAME)));
        resetDb();
    }
    ...
    public void testDeleteMultipleTags() {
        ...
        int affectedRows = mTagProvider.delete(Uri.parse(TagProvider.MULTIPLE_TAG_CONTENT_URI), Tag.COLUMN_NAME + " LIKE ?", new String[]{"%TestTag%"});
        ...
        affectedRows = mTagProvider.delete(Uri.parse(TagProvider.MULTIPLE_TAG_CONTENT_URI), Tag.COLUMN_NAME + " LIKE ?", new String[]{"%TestTag1%"});
