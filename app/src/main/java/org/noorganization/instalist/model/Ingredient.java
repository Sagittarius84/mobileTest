...
public class Ingredient extends SugarRecord<Ingredient> {
    ...
    public final static class COLUMN_TABLE_PREFIXED {
        ...
        public final static String COLUMN_RECIPE_ID = TABLE_NAME.concat(COLUMN_NO_TABLE_PREFIXED.COLUMN_RECIPE_ID);
        public final static String COLUMN_AMOUNT = TABLE_NAME.concat(COLUMN_NO_TABLE_PREFIXED.COLUMN_AMOUNT);
        public final static String[] ALL_COLUMNS = {COLUMN_ID, COLUMN_PRODUCT_ID, COLUMN_RECIPE_ID, COLUMN_AMOUNT};
    }
    ...
    public final static String DATABASE_CREATE = "CREATE TABLE " + TABLE_NAME
            ...
            + COLUMN_NO_TABLE_PREFIXED.COLUMN_RECIPE_ID + " TEXT,"
            + COLUMN_NO_TABLE_PREFIXED.COLUMN_AMOUNT + " REAL,"
            + "FOREIGN KEY (" + COLUMN_NO_TABLE_PREFIXED.COLUMN_PRODUCT_ID + ") REFERENCES " +  Product.TABLE_NAME + "( " + Product.COLUMN_NO_TABLE_PREFIXED.COLUMN_ID + " )"
            + "ON UPDATE CASCADE ON DELETE CASCADE,"
            + "FOREIGN KEY (" + COLUMN_NO_TABLE_PREFIXED.COLUMN_RECIPE_ID + ") REFERENCES " +  Recipe.TABLE_NAME + "( " + Recipe.COLUMN_NO_TABLE_PREFIXED.COLUMN_ID + " )"
            + "ON UPDATE CASCADE ON DELETE CASCADE"
            + ")";
    /**
     * @deprecated use {@link COLUMN_NO_TABLE_PREFIXED#COLUMN_ID}
     */
    public final static String ATTR_PRODUCT = StringUtil.toSQLName("mProduct");
    /**
     * @deprecated use {@link COLUMN_NO_TABLE_PREFIXED#COLUMN_AMOUNT}
     */
    public final static String ATTR_AMOUNT = StringUtil.toSQLName("mAmount");
    /**
     * @deprecated use {@link COLUMN_NO_TABLE_PREFIXED#COLUMN_RECIPE_ID}
     */
