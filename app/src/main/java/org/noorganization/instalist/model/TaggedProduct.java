...
public class TaggedProduct extends SugarRecord<TaggedProduct> {
    ...
    public final static String[] ALL_COLUMNS_JOINED = {Tag.COLUMN_TABLE_PREFIXED.COLUMN_ID, Tag.COLUMN_TABLE_PREFIXED.COLUMN_NAME,
            ...
            Product.COLUMN_TABLE_PREFIXED.COLUMN_ID, Product.COLUMN_TABLE_PREFIXED.COLUMN_NAME, Product.COLUMN_TABLE_PREFIXED.COLUMN_DEFAULT_AMOUNT,
            Product.COLUMN_TABLE_PREFIXED.COLUMN_STEP_AMOUNT, Product.COLUMN_TABLE_PREFIXED.COLUMN_UNIT_ID};
